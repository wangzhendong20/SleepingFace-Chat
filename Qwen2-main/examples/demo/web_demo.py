...
<p align="center"><img src="https://qianwen-res.oss-accelerate-overseas.aliyuncs.com/logo_qwen2.png" style="height: 80px"/><p>""")
        gr.Markdown("""<center><font size=8>SleepingFace Chat</center>""")
        gr.Markdown(
            """\
<center><font size=3>This is SleepingFace assistant, you can chat with it. \
    (这里是SleepingFace小助手, 你可以与它进行聊天。)</center>""")
        gr.Markdown("""\
<center><font size=4>
